...
console.log("expected output of reverse is gib " + myFunctionTest('gib', function () {
    return reverse('big');
}));
...
console.log("expected output of findLongestWord is 6 " + myFunctionTest(6, function () {
